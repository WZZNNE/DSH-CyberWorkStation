...
rem Resolve against the invocation directory before any pushd or child process.
set "DSH_RESOLVED_HOME="
set "DSH_HOME_RESOLVED_OK="
set "DSH_HOME_HELPER=%SUITE%launcher\home-paths.mjs"
...
set "DSH_REPO=%CORE%"
node "%SUITE%launcher\dsh-patch-layers.mjs" || (popd && exit /b 1)
...
copy /y "%SUITE%dsh-skills\skin-studio\SKILL.md" "%DSH_HOME%\skills\skin-studio\SKILL.md" >nul
if not exist "%DSH_HOME%\skills\control-deck-authoring" mkdir "%DSH_HOME%\skills\control-deck-authoring"
copy /y "%SUITE%dsh-skills\control-deck-authoring\SKILL.md" "%DSH_HOME%\skills\control-deck-authoring\SKILL.md" >nul
if not exist "%DSH_HOME%\skills\desktop-pet" mkdir "%DSH_HOME%\skills\desktop-pet"
copy /y "%SUITE%dsh-skills\desktop-pet\SKILL.md" "%DSH_HOME%\skills\desktop-pet\SKILL.md" >nul
