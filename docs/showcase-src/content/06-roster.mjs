  ...
  blocks: [
    { type: 'roster', groups: [
      ...
      { key: 'original', label: '套件插件 · 原创', badge: '原创', desc: '19 个。', items: [
        ...
        { name: 'dsh-skin-studio', ver: '0.1.0', origin: 'original', role: '在对话里让模型做皮肤（`skin_studio` 工具）。', where: '对话' },
        ...
        { name: 'dsh-temp-chat', ver: '0.1.1', origin: 'original', role: '不属于任何项目的临时对话。', where: '侧栏按钮' },
        { name: 'dsh-media-lab', ver: '0.1.1', origin: 'original', role: '生图 / 生视频 / 语音合成 / 语音识别，九种供应商 + 自定义接口，结果在对话里播放。', where: 'dsh 设置「多媒体 API」' },
        { name: 'dsh-desktop-pet', ver: '0.2.2', origin: 'original', role: '桌宠：人格、设定集、独立 API、主动搭话、提醒、语音、序列帧动画、看屏 / 操作电脑权限、三种窗口。', where: 'dsh 设置「桌宠」、侧栏' },
