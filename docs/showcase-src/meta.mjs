...
export default {
  ...
  shotDate: '2026-09-11',
  shotDir: 'docs/screenshots/2026-09',
  stats: [
    { n: '22', label: '套件插件', sub: '原创 19 · 二改 3' },
    { n: '13', label: '启动器页面', sub: '中英双语 · 3 款皮肤' },
    { n: '8', label: '社区插件', sub: '原样采纳，另有 1 个 MCP 服务器' },
    { n: '0', label: '本体改动', sub: '全部经官方扩展点实现' },
  ],
  badges: [
    ['core', '0.1.5-rc.2'],
    ['plugins', '22'],
